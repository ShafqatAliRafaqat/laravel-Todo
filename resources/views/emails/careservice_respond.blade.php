    ...
    <body class="no-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
        ...
        <div role="banner">
          ...
          <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
            <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
              <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 160px;" src="https://i1.createsend1.com/ei/j/8A/E3A/A44/204244/csfinal/Asset32x.png" alt="" width="160"></div>
            </div>
          </div>
        </div>
        <div role="section">
        <div style="background-color: #0376ea;">
      ...
      <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <h2 style="Margin-top: 0;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: left;">
            <span style="color:#0376ea">
              <strong>
                Your request for Care Service Order has been {{{ $status }}}
              </strong>
            </span>
          </h2>
        </div>
      ...
      <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <h2 style="Margin-top: 0;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: left;">
            <span style="color:#0376ea">
              <?php
                if ($status == config('app.hospitallCodes')['Declined']) {
              ?>
                  <strong>
                    Reason: 
                  </strong>
              ...
              <?php
                ...
                elseif ($status == config('app.hospitallCodes')['Approved']) {
              ?>
      ...
      <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <p style="Margin-top: 0;Margin-bottom: 0;">
            <strong>
              <span style="color:#707070">
                Order Type: {{{ $care_service_type_name }}}
                <br>
                Order#: {{{ $care_service_id }}}
                <br>
      ...
      <!-- <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <p style="Margin-top: 0;Margin-bottom: 0;"><strong><span style="color:#707070">Order Type: {{{ $care_service_type_name }}}<br>
  Order#: {{{ $care_service_id }}}</span></strong></p><p style="Margin-top: 20px;Margin-bottom: 0;">HI, {{{ $description }}}. &nbsp;It will be great if i can get this on {{{ $start_date }}} {{{ $start_time }}}. Kindly let me know the payment procedure too. Thanks in advance.&nbsp;</p><p style="Margin-top: 20px;Margin-bottom: 20px;"><br>
  {{{ $name }}},<br>
  User <span style="color:#0376ea">#HAU-234</span></p>
        </div>
      </div> -->
      ...
      <div style="Margin-left: 20px;Margin-right: 20px;">
        <div class="divider" style="display: block;font-size: 2px;line-height: 2px;Margin-left: auto;Margin-right: auto;width: 40px;background-color: #ccc;Margin-bottom: 20px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <p style="Margin-top: 0;Margin-bottom: 0;"><span style="color:#707070"><strong>Contact Details:</strong></span></p><p style="Margin-top: 20px;Margin-bottom: 0;">Number: &nbsp;<span style="color:#0376ea">{{{ $contact_number }}}</span><br>
  Address: {{{ $address }}}</p>
        </div>
      </div>
    ...
    <img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;" src="https://synavos.createsend1.com/t/j-o-ntliuyk-l/o.gif" width="1" height="1" border="0" alt="">
  <script type="text/javascript" src="https://js.createsend1.com/js/tsb.min.js?h=544AE0C5201807090459"></script>
  <script type="text/javascript" src="https://js.createsend1.com/js/compiled/app/content/emailPreviews.min.js?h=F2001D54201807090459" data-model='{"Scrollbars":true}'></script>
  </body></html>
